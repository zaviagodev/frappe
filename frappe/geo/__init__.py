...
class GeoSource(FrappeClient):
    ...
    def get_count(self, doctype, args):
        ...
        '''
        return super().get_api("frappe.desk.reportview.get_count", {
			"doctype": doctype,
			"filters": json.dumps(args.get("filters") or args.get("or_filters"))
		})
    
geo_Source = GeoSource(
    "https://hosting.zaviago.com",
    api_key="d01573463f4e0a4",
    api_secret="9cc0bbd234fd898"
)