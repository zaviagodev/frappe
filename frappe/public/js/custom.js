...
const modalMenus = [
  ...
  },
  {
    ...
    icon:`<svg xmlns="http://www.w3.org/2000/svg" width="30" height="31" viewBox="0 0 30 31" fill="none">
    <g clip-path="url(#clip0_1351_7861)">
      <path d="M36.25 0.5H8.75C3.91751 0.5 0 4.41751 0 9.25V36.75C0 41.5825 3.91751 45.5 8.75 45.5H36.25C41.0825 45.5 45 41.5825 45 36.75V9.25C45 4.41751 41.0825 0.5 36.25 0.5Z" fill="white"/>
      <path fill-rule="evenodd" clip-rule="evenodd" d="M26.5415 16.5962C26.727 16.7899 26.5897 17.1114 26.3215 17.1114H19.0821C19.0317 17.1114 18.9908 17.1523 18.9908 17.2027V22.4941C18.9908 22.6332 18.8966 22.7546 18.7618 22.7891L7.49981 25.674C7.44204 25.6888 7.38582 25.6452 7.38582 25.5855L7.38582 18.9651C7.38582 18.826 7.48006 18.7046 7.61481 18.6701L14.5187 16.9016C14.5873 16.884 14.6107 16.7986 14.5606 16.7486L3.332 5.51992C3.14014 5.32805 3.27602 5 3.54736 5H15.3986C15.4235 5 15.4474 5.01017 15.4646 5.02816L26.5415 16.5962Z" fill="#1A1A1A"/>
    </g>
    <defs>
      <clipPath id="clip0_1351_7861">
        <rect width="30" height="30" fill="white" transform="translate(0 0.5)"/>
      </clipPath>
    </defs>
  </svg>`,
  ...
  },
  {
    ...
    icon:`<svg width="32" height="31" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <rect y="0.5" width="31.5" height="30" rx="4" fill="url(#pattern0)"/>
    <defs>
    <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image0_1351_7874" transform="matrix(0.0277778 0 0 0.0291667 0 -0.025)"/>
    </pattern>
    <image id="image0_1351_7874" width="36" height="36" xlink:href="data:image/png;base64,"/>
    </defs>
    </svg>
    `,
    enabled:false
